...
(расчет расхода калорий в зависимости от блюда выполняется с помощью API https://nutritionix.com, для перевода на английский язык испольуется библиотека `GoogleTranslator`)  
...
(расчет расхода калорий в зависимости от тренировки и времени выполняется с помощью API https://trackapi.nutritionix.com, для перевода на английский язык испольуется библиотека `GoogleTranslator`)    
